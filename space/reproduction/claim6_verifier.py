#!/usr/bin/env python3
"""Verify Claim 6 from frozen raw evidence and an independent checker."""
...
CLAIM_DIR = ROOT / ".openresearch" / "artifacts" / "claim_6"
CHECKER = Path(__file__).with_name("claim6_checker.py")
...
def main() -> int:
    ...
    if contract["verdict"] != "FALSIFIED":
        raise RuntimeError("Claim 6 contract must retain FALSIFIED")
